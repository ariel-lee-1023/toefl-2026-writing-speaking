...
Write an email to Ms. Sorensen. In your email, do the following:

Explain the purpose of the workshop series.
Describe the schedule and age group of participants.
Ask whether she would be interested in leading a session.
...
## My Score Explained
The email achieves a 5/5 score by flawlessly executing all prompt instructions for official outreach. It defines the community program's mission ("introduce local teenagers aged thirteen to seventeen... develop artistic confidence"), clearly details event logistics ("Saturday mornings from ten to twelve throughout July and August"), and extends a polished, formal invitation ("guest-leading a two-hour session on painting fundamentals... discuss honorariums"). The vocabulary ("productive outlet", "honorariums", "extensive background") is high-register and precise, featuring flawless complex syntax.
