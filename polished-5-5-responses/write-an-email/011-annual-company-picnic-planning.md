...
Write an email to your coworkers. In your email, do the following.

Explain what needs to be done before the picnic.
Make a suggestion for the picnic location.
Ask for volunteers to help you organize it.
...
## My Score Explained
The response earns a 5/5 score under official ETS evaluation criteria. It addresses all required prompt points with appropriate detail: outlining pre-event requirements ("choosing a location, planning the food and beverage menu, and organizing fun activities"), proposing a concrete venue with justification ("Riverfront Park... open green space, shaded pavilion areas, beautiful scenery"), and explicitly inviting volunteers with a clear deadline ("let me know by this Friday"). The email uses a professional and friendly tone suited for company-wide internal communication, demonstrating smooth cohesive logic, varied syntactic patterns, and precise vocabulary.
