...
Write an email to Ms. Dubois, the housing coordinator. In your email, do the following:

Describe the problem with the heating system.
Explain how it has affected your daily routine.
Request a specific time for a maintenance visit.
...
## My Score Explained
The response attains a 5/5 score for concise, clear, and action-oriented problem Reporting. It details the technical malfunction ("thermostat has failed to heat properly... temperatures drop significantly every night"), highlights the tangible personal impact ("severely disrupts our daily routine... hard to sleep and focus on studies"), and gives an exact time window for maintenance with availability confirmation ("tomorrow between 2:00 p.m. and 4:00 p.m."). The register is appropriately firm yet polite, maintaining full grammatical control.
