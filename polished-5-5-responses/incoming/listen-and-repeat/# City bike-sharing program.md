...
1. Begin by choosing a bike from the station.
2. Use the payment stand to pay for your rental.
3. Refer to the map for information on nearby routes.
4. Return the vehicle to any open space available.
5. Locks are necessary to prevent any potential theft.
6. Perform a quality check and resolve any issues before starting your ride.
7. Follow all traffic rules and remember that you are required to wear a helmet.

## Set Map
| # | Block | Chunks | Shape / cue words | At-risk function words | At-risk endings |
|---|-------|--------|-------------------|------------------------|-----------------|
| 1 | Short | Action + Place | Direct imperative | by, from | choosing, station |
| 2 | Medium | Action + Purpose | to + for | to, for, the | payment, rental |
| 3 | Medium | Action + Purpose + Place | for + on | to, for, on | routes |
| 4 | Short | Action + Place | to + any | to, any | vehicle, available |
| 5 | Medium | Statement + Purpose | are + to | are, to, any | necessary, prevent, theft |
